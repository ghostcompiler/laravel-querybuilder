...
class Container_e2f76533f7 extends _PHPStan_77a324412\Nette\DI\Container
{
	protected $tags = [
		'phpstan.rules.rule' => [
			'029' => true,
	...
	public function createService0445(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_e2f76533f7 $container)
			{
	...
	public function createServiceContainer(): Container_e2f76533f7
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'_' => '/Users/ghostcompiler/Desktop/GhostCompiler/laravel-querybuilder/vendor/bin/phpstan',
				'LINES' => '50',
				'COLUMNS' => '80',
				'SHELL_VERBOSITY' => '0',
			],
